...
abbreviated RCHAM, which is a modification of the basic CHAM.

This calculus defines only the concepts of processes $P$, join patterns $J$ and definitions $D$.
The syntax of these constructs are given by
