...
\begin{align*}
\inferrule[Red-Match]
{\M \equiv~\vdash_t^\phi \textbf{match}~e~\textbf{with}~\pi_1
   \rightarrow Q_1 ~|~...
 \\ \M' \equiv~\vdash_t^\phi \sigma_{rv}Q_i
 \\ \P_\pi(\pi_1, e) = \sigma_{rv}
}
{\M \longrightarrow \M'}
\end{align*}
\begin{align*}
\inferrule[Red-Nomatch]
{\M \equiv~\vdash_t^\phi \textbf{match}~e~\textbf{with}~\pi_1 \rightarrow Q_1 ~|~ \pi_2 \rightarrow Q_2 ~|~ ... ~|~ \pi_m \rightarrow Q_m
\\ \M' \equiv~\vdash_t^\phi \textbf{match}~e~\textbf{with}~\pi_2 \rightarrow Q_2 ~|~ ... ~|~ \pi_m \rightarrow Q_m
\\ \P_\pi(\pi_1,e) = fail}
{\M \longrightarrow \M'}
\end{align*}
\begin{align*}
\inferrule[Red-Match-Empty]
{\M \equiv~\vdash_t^\phi \textbf{match}~e~\textbf{with}~\emptyset}
{
\M \longrightarrow \vdash_t^\phi halt\langle\rangle
}
\end{align*}
\end{minipage}}
