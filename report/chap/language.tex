...
Zero or more CHAMs can be composed in parallel, which is modelled using a set:
\begin{align*}
 \C ::={}& \{ \M_1, \M_2, ..., \M_n \}
\end{align*}
...
\fixme{This subsection could just as well be moved to the introduction of the
semantics section.}
...
\fixme{Look into changing Halt/Go to maintain quiescence, by delaying
computations in all affected machines. Same goes for Spawn.}
\begin{description}
