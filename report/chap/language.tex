...
\qquad \mathcal{M}' \equiv \mathcal{D}_1 \vdash_t^\phi \mathcal{A}_1'
\qquad \mathcal{M} \longrightarrow \mathcal{M}'}
...
\textsc{Sched-Par}\quad&
\frac
{\mathcal{M} \stackrel{t}{\propto} P
\qquad \mathcal{M} \stackrel{t}{\propto} Q}
...
\textsc{Red}\quad&
\frac
{\mathcal{M} \equiv J \stackrel{d}{\triangleright} Q \vdash_t P
\qquad\mathcal{M} \stackrel{t'}{\propto} P
\qquad t'+d = t
\qquad \mathcal{P}(P) = \sigma_{rv}J }
{ M \longrightarrow
  J \stackrel{d}{\triangleright} Q \vdash_t t : \sigma_{rv}Q }
\end{align*}
In \textsc{Red}, $\sigma_{rv}$ replaces received variables with closed
expressions.

Prioritized pattern matching is performed using the following rule:
\begin{align*}
\textsc{Red-Match}\quad&
 ...
\end{align*}
...
disappear:
\begin{align*}
\textsc{Comm-Link}\quad &
\frac
{ x \in dv(\mathcal{D}_2)
  \quad a \stackrel{t}{\diamond} b}
{ \mathcal{D}_1 \vdash^{a\phi}_t \mathcal{A}_1, t:x\langle \tilde e \rangle ~||~ \mathcal{D}_2 \vdash^{b\psi}_t \mathcal{A}_2 ~\longrightarrow~
  \mathcal{D}_1 \vdash^{a\phi}_t \mathcal{A}_1 ~||~ \mathcal{D}_2 \vdash^{b\psi}_t \mathcal{A}_2, (t+1) : x \langle \tilde e \rangle } \\
\textsc{Comm-Lost}\quad &
\frac
{ x \in dv(\mathcal{D}_2)
  \quad \neg(a \stackrel{t}{\diamond} b)}
{ \mathcal{D}_1 \vdash^{a\phi}_t \mathcal{A}_1, t:x\langle \tilde e \rangle ~||~ \mathcal{D}_2 \vdash^{b\psi}_t \mathcal{A}_2 ~\longrightarrow~
  \mathcal{D}_1 \vdash^{a\phi}_t \mathcal{A}_1 ~||~ \mathcal{D}_2 \vdash^{b\psi}_t \mathcal{A}_2 }
\end{align*}
