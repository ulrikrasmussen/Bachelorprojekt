...
Independent processes in a single machine can take evaluation steps independent
...
when the time of the two communicating machines are synchronised.\fixme{But, isn't this the always the case in this semantics :o}
...
\end{equation*}
\fixme{For the time being we'll just let time pass here and allow
