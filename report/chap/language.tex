...
\subsubsection{Distribution and mobility}
...
\doms{$\T_\Sigma ::= (a \mapsto \phi) ~|~ \Sigma_1 \cup \Sigma_2$}
...
{\Sigma = \Sigma_1 \cup \Sigma_2
\\ \U(\Sigma_1, a) \leadsto \top
\\ \U(\Sigma_2, a) \leadsto \top}
{\U(\Sigma, a) \leadsto \top}
\end{equation*}

\end{minipage}}
\caption{Rules defining the semantics of a key/value map with detection of non-existing keys.}\label{fig:rule:sigma}
\end{figure}
...
\end{equation*}
\end{minipage}}
\caption{Rules for determining the full prefix of all location names in a system.}\label{fig:rule:makemap}
\end{figure}
