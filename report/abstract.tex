...
%an operational semantics that avoids dependency on structural equivalence for
%execution, along with our own extensions that enables us to model unreliable
