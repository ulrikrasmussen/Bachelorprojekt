...
syntax include @nowebIncludedJoin syntax/join.vim
...
syntax region nowebCode start=/<<.>>=\|<<[^ ].*[^ ]>>=/ end=/^@ \|^@$/me=e-3 contains=@nowebIncludedJoin, nowebName containedin=tex.*Zone
...
syntax region nowebCode start=/<<.*\[join\]>>=/ end=/^@ \|^@$/me=e-3 contains=@nowebIncludedJoin, nowebName containedin=tex.*Zone
